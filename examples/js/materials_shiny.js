window.onload = function() {
  var camera, controls, count, geometry, grid, gui, height, ix, iz, material, mesh, offset, plane, reflection, render, scene, size, spacing, sunsky, threeflow, webgl, width, _i, _j,
    _this = this;
