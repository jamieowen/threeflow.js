...
module.exports = {
  ...
  Render: Render = (function() {
    ...
    function Render(client, source, options, sunflowCl) {
      ...
      this.status = "queued";
      if (this.options.deleteSc === void 0 || this.options.deleteSc === null) {
        this.options.deleteSc = true;
      }
    ...
    Render.prototype.cleanUp = function() {
      ...
      if (!flags.allowSave || (flags.deleteSc && this.options.deleteSc) || (!flags.deleteSc && this.options.deleteSc)) {
