...
io.sockets.on('connection', function(socket) {
  ...
  socket.on('render', function(data) {
    var child, command, doneMatch, isDone, pngPath, progressIntMatch, progressMatch, renderTime, renderTimeMatch, scPath;
    if (data.scContents) {
      ...
      command += " " + scPath;
      child = child_process.exec(command, function(error, stdout, stderror) {
